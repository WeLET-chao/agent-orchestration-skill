...
6. Prepare each task prompt with scope, allowed files, forbidden actions, verification, artifacts, and report format.
7. If the task depends on repo policy, require Cursor to read `AGENTS.md`, project context docs, relevant design docs/issues, and touched code entry points.
